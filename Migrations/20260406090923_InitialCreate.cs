    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Badges",
                columns: new[] { "Id", "ColorHex", "Description", "IconClass", "Name", "XPRequired" },
                values: new object[,]
                {
                    { 1, "#f59e0b", "Complete your first quiz", "bi-star", "First Step", 0 },
                    { 2, "#f59e0b", "Earn 100 XP", "bi-star-fill", "Rising Star", 100 },
                    { 3, "#6366f1", "Earn 500 XP", "bi-mortarboard", "Scholar", 500 },
                    { 4, "#10b981", "Earn 1000 XP", "bi-trophy", "Expert", 1000 },
                    { 5, "#ef4444", "Earn 5000 XP", "bi-trophy-fill", "Legend", 5000 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "#6366f1", null, "bi-diagram-3", "Data Structures & Algorithms" },
                    { 2, "#0ea5e9", null, "bi-hdd-network", "Computer Networks" },
                    { 3, "#10b981", null, "bi-cpu", "Operating Systems" },
                    { 4, "#f59e0b", null, "bi-database", "Database Management" },
                    { 5, "#ef4444", null, "bi-boxes", "Object Oriented Programming" },
                    { 6, "#8b5cf6", null, "bi-layers", "System Design" }
                });
